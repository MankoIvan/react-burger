...
export const registerUserRequest = ({
  ...
  password,
  name,
}: TRegisterUserRequest): Promise<TRegisterUserResponse> => {
...
export const loginUserRequest = ({
  email,
  password,
}: TLoginUserRequest): Promise<TLoginUserResponse> => {
...
export const forgotPasswordRequest = ({
  email,
}: TForgotPasswordRequest): Promise<TForgotPasswordResponse> => {
...
export const resetPasswordRequest = ({
  password,
  token,
}: TResetPasswordRequest): Promise<TResetPasswordResponse> => {
